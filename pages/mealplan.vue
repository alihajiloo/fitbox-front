    ...
    <div>
      <nav class="bg-primary-800">
            ...
            <div class="flex items-center">
              ...
              <div class="hidden md:block">
                <div class="mr-10 flex items-baseline">
                  <NuxtLink
                    to="/dashboard"
                    class="focus:outline-none rounded-md px-3 py-2 text-sm font-medium text-white focus:bg-gray-700 focus:text-white"
                    >داشبورد</NuxtLink
                  >
                  <NuxtLink
                    to="/workoutplan"
                  ...
                  <NuxtLink
                    to="/mealplan"
                    class="focus:outline-none mr-4 rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white hover:bg-gray-700 hover:text-white focus:bg-gray-700 focus:text-white"
        ...
        <div :class="[isOpen ? '' : 'hidden', 'md:hidden']">
          <div class="px-2 pt-2 pb-3 sm:px-3">
            <NuxtLink
              to="/dashboard"
              class="focus:outline-none block rounded-md px-3 py-2 text-base font-medium text-white focus:bg-gray-700 focus:text-white"
              >داشبورد</NuxtLink
            >
            <NuxtLink
              to="/workoutplan"
              class="focus:outline-none mt-1 block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white hover:bg-gray-700 hover:text-white focus:bg-gray-700 focus:text-white"
              >برنامه ورزشی</NuxtLink
            >
            <NuxtLink
              to="/mealplan"
      ...
      <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold leading-tight text-gray-900">برنامه غذایی</h1>
        </div>
      </header>
      <main>
